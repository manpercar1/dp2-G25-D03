...
@Service
public class AdministratorTaskListSortedByWorkloadService  implements AbstractListService<Administrator, Task>{
	...
	public Collection<Task> findMany(final Request<Task> request) {
		...
		return this.repository.findTasksOrderByWorkload(principal.getAccountId());
